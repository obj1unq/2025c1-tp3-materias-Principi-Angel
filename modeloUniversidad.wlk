...
const programacion = new Carrera (materias = #{elementos, matematicaI, objetosI, objetosII, objetosIII, tpFinal, basesDeDatos, progConcurrente, estructuras })
...
const estructuras     = new MateriaDeProgramacion ()
