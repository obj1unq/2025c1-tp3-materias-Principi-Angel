...
const objetosIII      = new MateriaDeProgramacion (cupo = 5, tieneCorrelativas = true, correlativas = #{objetosII, basesDeDatos})
const progConcurrente = new MateriaDeProgramacion ( tieneCorrelativas = true, correlativas = #{objetosI, basesDeDatos})
const tpFinal         = new MateriaDeProgramacion (cupo = 2, tieneCorrelativas = true, correlativas = #{objetosIII})
...
const quimica      = new MateriaDeMedicina (cupo = 10)
const biologiaI    = new MateriaDeMedicina (cupo = 10)
